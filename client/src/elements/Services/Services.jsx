...
export default function Services() {
  ...
  const [services] = useState([
    ...
    {
      title: 'Покрытие защитными покрытиями',
      text: 'Lorem ipsum dolor sit amet consectetur adipisicing elit.',
    },
    {
      title: 'Деликатная химчистка',
      text: 'Lorem ipsum dolor sit amet consectetur adipisicing elit.',
    },
    {
      title: 'Оклейка',
    ...
    {
      title: 'Полировка',
      text: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. it amet consectetur adipisicing elit.',
    },
  ...
  return (
    <div className="services-count">
      <div className="services">
        ...
        <div className="services-map" style={{ maxWidth: '80vw' }}>
          {services.map((el) => (
            <div className="services-map-count">
              <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-droplet" viewBox="0 0 16 16" style={{ marginRight: '15px' }}>
              ...
              <div className="services-item-map" key={el.title}>
